...
# ================= 3. MASTER PDF SCRAPER (COORDINATE BASED) =================
...
if mode == "Audit vs Repository":
...
else: # --- VERSION CONTROL MODE (CORRECTED) ---
    ...
    with col_a:
        ...
        data_a = res_a.data
        if data_a: st.image(data_a['image_url'], width=450, caption="Version A (Repo)")
    ...
    with col_b:
        ...
        if file_b:
            ...
            if data_b: st.image(data_b['img'], width=450, caption="Version B (New Upload)")
