# ==========================================================
# AI FASHION AUDITOR V42.4 - ZERO CRASH & FULL POM SCAN
# ==========================================================
...
st.set_page_config(layout="wide", page_title="AI Fashion Pro V42.4", page_icon="📊")
...
# --- TRÍCH XUẤT SIÊU MẠNH (DÀNH CHO REITMANS) ---
    ...
    try:
        ...
        with pdfplumber.open(io.BytesIO(pdf_content)) as pdf:
            for page in pdf.pages:
                ...
                # Chỉ quét trang GRADING NOT APPROVED của Reitmans
...
with st.sidebar:
    ...
    files = st.file_uploader("Nạp mẫu gốc Reitmans", accept_multiple_files=True, key=f"u_{st.session_state.up_key}")
...
# --- MAIN: ĐỐI SOÁT ---
st.title("🔍 AI Fashion Auditor V42.4")
        ...
        if db_res.data:
            ...
            for i in db_res.data:
                if i.get('vector'):
                    ...
                    # 🔥 FIX LỖI TYPEERROR TẠI ĐÂY: Lấy đúng giá trị sim_m[0][0]
                    sim_val = float(sim_m[0][0]) * 100
